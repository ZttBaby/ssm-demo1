...
<table class="table table-striped table-hover table-bordered">
    ...
    <td colspan="4">
        ...
        <c:if test="${pageInfo.pageIndex!=1}">
                <li><a href="${pageContext.request.contextPath }/findUsers?page1=${pageInfo.pageIndex-1}">上一页</a></li>
        </c:if>
        ...
        <c:forEach begin="1" end="${pageInfo.totalPage}" var="page">
            ...
            <c:if test="${page==pageInfo.pageIndex  }">
             ...
             <c:if test="${page!=pageInfo.pageIndex  }">
           <li> <a href="${pageContext.request.contextPath }/findUsers?page1=${page}">${page }</a></li>
            </c:if>
        ...
        <c:if test="${pageInfo.pageIndex!=pageInfo.totalPage}">
            <li><a href="${pageContext.request.contextPath }/findUsers?page1=${pageInfo.pageIndex+1}">下一页</a></li>
        </c:if>
        </ul>
        </nav>
    </td>
